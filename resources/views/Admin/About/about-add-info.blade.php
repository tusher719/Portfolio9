...
@section('mainsection')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">About add info</li>
    </ol>
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card" style="border: 1px solid #17a2b8 ";>
                <div class="card-header bg-info">
                    <h4>About Add Information</h4>
                </div>
                <div class="card-body bg-secondary">
                    <form method="POST" enctype="multipart/form-data" action="{{route('about.create')}}">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label"><h6 style="color: #fff">About Name</h6></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="About Name..." name="about_name">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" placeholder="About Description..." name="about_description" cols="70" rows="3"></textarea>
                            </div>
                        </div>
